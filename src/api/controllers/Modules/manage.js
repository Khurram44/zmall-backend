var module = require("../../models/Modules/manage")
...
exports.getList = (req,res) =>{
 ...
 exports.getManageByID =(req, res) =>{
     module.getManageByID(req.params.id,(err,product)=>{
        if(err)
        {
           res.send(err)
        }
...
exports.deleteProduct = (req,res) =>{
   module.deleteProduct(req.params.id,(err,result)=>{
      if (err)
      {
         res.send(err)
      }
