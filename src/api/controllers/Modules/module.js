...
exports.getModulesByID= (req,res)=>{
   module.getModulesByID(req.params.id,(err,Modules)=>{
      if(err)
      {
         res.send(err)
      }
...
exports.AddModules=(req,res)=>{
   ...
   if(req.body.constructor === Object && Object.keys(req.body).length===0)
   {
      ...
      module.createModules(data,(err,emp)=>{
         if(err)
         {
            res.send(err)
         }
...
exports.UpdateModules=(req,res)=>{
   ...
   if(req.body.constructor === Object && Object.keys(req.body).length===0)
   {
      ...
      module.updateModules(req.params.id,data,(err,emp)=>{
         if(err)
         {
            res.send(err)
         }
...
exports.deleteModules = (req,res) =>{
   module.deleteModules(req.params.id,(err,result)=>{
      if (err)
      {
         res.send(err)
      }
